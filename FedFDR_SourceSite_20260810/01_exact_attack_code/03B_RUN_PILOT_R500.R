...
# N = 500. Stability pilot after singleton-glmnet implementation patch.
# ============================================================
...
cfg <- make_config(n_reps = 500L)
out_dir <- file.path("results_pilot_R500")
dir.create(out_dir, showWarnings = FALSE, recursive = TRUE)

cat("\n========================================\n")
cat("Fed-FDR Source-Site Attack PILOT R500\n")
...
saveRDS(results, file.path(out_dir, "pilot_R500_results.rds"))
utils::write.csv(results, file.path(out_dir, "pilot_R500_results.csv"), row.names = FALSE)
...
cat("Inspect empty-support failure rate and attack stability before formal N=10,000.\n")
